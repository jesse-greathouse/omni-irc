...
📄 **Design & UI/Client contract:** see **[`docs/omni-irc-UI-Client-Contract.pdf`](docs/omni-irc-UI-Client-Contract.pdf)**  
...
👉 [`docs/omni-irc-UI-Client-Contract.pdf`](docs/omni-irc-UI-Client-Contract.pdf)
